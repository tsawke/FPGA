...
entity lz4CompressEngineRun_fifo_w32_d8_S is 
    generic (
...
architecture rtl of lz4CompressEngineRun_fifo_w32_d8_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component lz4CompressEngineRun_fifo_w32_d8_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 8);
...
begin
----------------------- Instantiation -----------------------
    U_lz4CompressEngineRun_fifo_w32_d8_S_ShiftReg : lz4CompressEngineRun_fifo_w32_d8_S_ShiftReg
    generic map (
...
entity lz4CompressEngineRun_fifo_w32_d8_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 8);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end lz4CompressEngineRun_fifo_w32_d8_S_ShiftReg;

architecture rtl of lz4CompressEngineRun_fifo_w32_d8_S_ShiftReg is
