namespace eval ::optrace {
  variable script "/root/FPGA/data_compression/L1/tests/lz4_compress/hls/hls/impl/verilog/project.runs/impl_1/bd_0_wrapper.tcl"
...
set rc [catch {
  ...
  open_checkpoint /root/FPGA/data_compression/L1/tests/lz4_compress/hls/hls/impl/verilog/project.runs/impl_1/bd_0_wrapper.dcp
  set_property webtalk.parent_dir /root/FPGA/data_compression/L1/tests/lz4_compress/hls/hls/impl/verilog/project.cache/wt [current_project]
  set_property parent.project_path /root/FPGA/data_compression/L1/tests/lz4_compress/hls/hls/impl/verilog/project.xpr [current_project]
  set_property ip_repo_paths /root/FPGA/data_compression/L1/tests/lz4_compress/hls/hls/impl/ip [current_project]
  update_ip_catalog
  set_property ip_output_repo /root/FPGA/data_compression/L1/tests/lz4_compress/hls/hls/impl/verilog/project.cache/ip [current_project]
